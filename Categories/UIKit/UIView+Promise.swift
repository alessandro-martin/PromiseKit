...
extension UIView {
    ...
    */
    public class func animate(duration: TimeInterval = 0.3, delay: TimeInterval = 0, options: UIViewAnimationOptions = UIViewAnimationOptions(), animations: () -> Void) -> Promise<Bool> {
