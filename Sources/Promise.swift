...
public class Promise<T> {
    ...
    */
    ...
    /**
     ...
     - SeeAlso: `thenInBackground`
    */
    public func then(on q: DispatchQueue = PMKDefaultDispatchQueue()!, body: (T) throws -> AnyPromise) -> Promise<AnyObject?> {
    ...
    */
    public func thenInBackground<U>(_ body: (T) throws -> U) -> Promise<U> {
        return then(on: DispatchQueue.global(attributes: DispatchQueue.GlobalAttributes(rawValue: UInt64(0))), body)
    }
